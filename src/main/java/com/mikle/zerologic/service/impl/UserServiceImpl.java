...
import com.mikle.zerologic.model.enums.UserRoleEnum;
...
import static com.mikle.zerologic.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public User getLoginUser(HttpServletRequest request) {
        ...
        if (!(loginState instanceof Number userId)) {
            throw new BusinessException(ErrorCode.NOT_LOGIN_ERROR);
        }
        // 从数据库查询当前用户信息
        User currentUser = this.getById(userId.longValue());
        if (currentUser == null) {
            throw new BusinessException(ErrorCode.NOT_LOGIN_ERROR);
        }
        return currentUser;
